...
async def main(test_config,os_setting,app_setting,tune_conf):
  ...
  dataszie_values_list = {'terasort':[1000000, 64000000],
                   'wordcount': [800000000, 6400000000],
  ...
  datasize_list = {'terasort':[7200000,10000000,15000000,24000000,32000000],  # 3200000,
                   'wordcount': [1600000000, 2400000000, 3200000000, 4800000000, 6400000000],     # slarge,llarge,large,shuge,lhuge
                   'aggregation': [5000000+600000, 10000000+1200000, 15000000+1800000, 20000000+2400000, 25000000+3000000],
  ...
  samples_df = pd.read_csv('/home/hmj/tuning_spark/target/target_spark/data/initial/sql/aggregation_samples_30.csv')  #
