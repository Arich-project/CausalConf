...
async def main(test_config,os_setting,app_setting,tune_conf):
  ...
  tune_column = ['jvm_new_ratio', 'spark_executor_cores', 'spark_memory_offHeap_size', 'spark_storage_replication_proactive',
                   'spark_shuffle_compress', 'spark_shuffle_sort_bypassMergeThreshold', 'spark_scheduler_revive_interval',
                   'spark_speculation', 'spark_storage_memoryMapThreshold', 'spark_executor_memory']
  # 'spark_task_maxFailures', 'spark_locality_wait', 'spark_kryoserializer_buffer','jvm_survivor_ratio', 'spark_broadcast_blockSize', 'jvm_gc_timeratio', 'spark_driver_memory', 'jvm_gc_collect','spark_memory_storageFraction',

      #['spark_storage_replication_proactive', 'spark_executor_memory', 'spark_storage_memoryMapThreshold', 'spark_task_maxFailures', 'spark_driver_memory', 'spark_memory_fraction', 'spark_shuffle_sort_bypassMergeThreshold', 'spark_speculation', 'spark_shuffle_file_buffer', 'spark_io_compression_codec']
      # ['spark_broadcast_blockSize', 'spark_task_maxFailures', 'spark_rdd_compress','spark_executor_cores',
      #            'spark_speculation','spark_shuffle_sort_bypassMergeThreshold', 'spark_storage_replication_proactive','spark_driver_memory',
      #            'spark_scheduler_revive_interval','jvm_max_gc_pause'] #'spark_memory_fraction',
  ...
  for task_id in tqdm(range(test_config.optimizer.iter_limit)):
    ...
    for rep in range(test_config.optimizer.repitition):
        ...
        # )
        # result_list.append(- result)   # result_list.append(round(random.uniform(-40, -50), 3))

        # # model predict
        filename = './predict_models/Z_finalized_model.sav'  # 模型名称
        model = pickle.load(open(filename, 'rb'))  # 载入离线模型
        # Samples = []
        Samples = [80000000] #[20000]#[5000000] #
